...
const PMAD_I18N = {
  nl: {
    ...
    "projects.beukenlaan.d1": "Achtergevel met dakterras en balkons (render)",
    "projects.beukenlaan.d2": "Voorgevel en tuin (render)",
    "projects.beukenlaan.d3": "Gevel vanaf de tuinzijde (render)",
    "projects.beukenlaan.d4": "Begane grond: open keuken en eetkamer (render)",
    "projects.beukenlaan.d5": "Begane grond: woonkamer (render)",
    "projects.beukenlaan.d6": "Begane grond: hal en trapopgang (render)",
    "projects.beukenlaan.d7": "2e verdieping: slaapkamer (render)",
    "projects.beukenlaan.d8": "2e verdieping: open keuken en woonruimte onder de kap (render)",
    "projects.beukenlaan.d9": "2e verdieping: woonkamer onder de kap (render)",
    "projects.beukenlaan.d10": "2e verdieping: woonruimte met dakraam (render)",
  ...
  en: {
    ...
    "projects.beukenlaan.d1": "Rear facade with roof terrace and balconies (render)",
    "projects.beukenlaan.d2": "Front facade and garden (render)",
    "projects.beukenlaan.d3": "Facade from the garden side (render)",
    "projects.beukenlaan.d4": "Ground floor: open kitchen and dining area (render)",
    "projects.beukenlaan.d5": "Ground floor: living room (render)",
    "projects.beukenlaan.d6": "Ground floor: hall and staircase (render)",
    "projects.beukenlaan.d7": "Second floor: bedroom (render)",
    "projects.beukenlaan.d8": "Second floor: open kitchen and living area under the roof (render)",
    "projects.beukenlaan.d9": "Second floor: living room under the roof (render)",
    "projects.beukenlaan.d10": "Second floor: living area with skylight (render)",
    "projects.beukenlaan.metaTitle": "Beukenlaan 01, Oosterbeek — PM|AD",
